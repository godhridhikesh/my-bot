class script(object):
    START_TXT = """Hᴀɪ ᴛʜᴇʀᴇ {}.ɪᴀᴍ Yᴏᴢᴏʀᴀ  🌸,

   Iᴀᴍ ᴀ ᴡᴇʟʟ ᴍᴀɪɴᴛᴀɴᴇᴅ ᴀᴜᴛᴏ ғɪʟᴛᴇʀ  ʙᴏᴛ 🦋 ʏᴏᴜ ᴄᴀɴ ᴀsᴋ ᴍᴇ ᴛʜᴇ ᴍᴏᴠɪᴇs, sᴇʀɪᴇs ʏᴏᴜ ᴡᴀɴᴛ ..🍭

Wᴇʟʟ ɪ ᴏɴʟʏ ᴡᴏʀᴋ ᴀᴛ ᴍʏ ɢʀᴏᴜᴘ sᴏ ʏᴏᴜ ᴄᴀɴ sᴇᴇ ᴍᴇ ᴛʜᴇʀᴇ 🍃
...
Name - {}
"""
    TIP_TEXT = """sᴇɴᴅ ᴄᴏʀʀᴇᴄᴛ ᴍᴏᴠɪᴇ/sᴇʀɪᴇs ɴᴀᴍᴇ ғᴏʀ ʙᴇᴛᴛᴇʀ ʀᴇsᴜʟᴛs.ᴛᴏ ɢᴇᴛ ʙᴇᴛᴛᴇʀ ʀᴇsᴜʟᴛ ғᴏʀ sᴇʀɪᴇs sᴇᴀʀᴄʜ ʟɪᴋᴇ ᴇxᴀᴍᴘʟᴇ ɢɪᴠᴇɴ,EG :- Stranger Things S01E01
"""
